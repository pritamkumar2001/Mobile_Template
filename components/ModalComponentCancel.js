  ...
  return (
    <Modal visible={isVisible} transparent={true} animationType="slide">
      <ModalContainer>
        <ModalContent>
          <Header>
            <TitleText>Cancel Leave - {leave.emp_data.emp_id}</TitleText>
          ...
          <CancelButton onPress={cancelLeave}>
...
export default ModalComponentCancel;
