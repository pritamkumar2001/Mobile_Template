  ...
  return (
    <Modal visible={isVisible} transparent={true} animationType="slide">
      <ModalContainer>
        <ModalContent>
          <Header>
            <TitleText>Approve Leave - {leave.emp_data.emp_id}</TitleText>
          ...
          <CancelButton onPress={approveLeave}>
...
export default ModalComponentApprove;
